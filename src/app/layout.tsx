...
export const metadata: Metadata = {
  ...
  description:
    'CZT - Free CoD Zombies tracker: Easter egg guides, challenges, speedruns, leaderboards, co-op logging, verified runs, XP and ranks. Custom Zombies—browse and submit community maps. Ask LeKronorium—our AI with exclusive zombies knowledge. WW2, IW, AW, Vanguard, MW2. Find group, friends, messaging. No ads.',
  keywords: [
    'CZT',
    'CZT CoD Zombies',
    'CZT Zombies Tracker',
  ...
  openGraph: {
    ...
    title: 'CoD Zombies Tracker – Easter Egg Guides, Leaderboards, Custom Zombies & Verified Runs',
    description: 'Free CoD Zombies tracker. Easter egg guides, challenges, speedruns, leaderboards, Custom Zombies map submission, co-op logging, verified runs. WW2, IW, AW, Vanguard, MW2. No ads.',
    url: BASE,
    images: [{ url: `${BASE}/opengraph-image`, width: 1200, height: 630, alt: 'CoD Zombies Tracker' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'CoD Zombies Tracker – Easter Egg Guides, Custom Zombies & Leaderboards',
    description: 'Free CoD Zombies tracker. Easter egg guides, Custom Zombies maps, challenges, speedruns, co-op logging, verified runs. No ads.',
  },
  robots: {
    index: true,
    follow: true,
  ...
  '@graph': [
    {
      ...
      alternateName: 'CZT',
      description: 'Free CoD Zombies tracker. Easter egg guides, challenges, speedruns, leaderboards, Custom Zombies maps, co-op logging, verified runs, XP and ranks. WW2, IW, AW, Vanguard, MW2. No ads.',
      potentialAction: [
        ...
        { '@type': 'ViewAction', target: BASE + '/maps', name: 'Browse Custom Zombies Maps' },
