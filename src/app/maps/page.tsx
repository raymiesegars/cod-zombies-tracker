...
import { Input, Select, Badge, Logo, MapIcon, PageLoader } from '@/components/ui';
...
export default function MapsPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const [mapsRes, gamesRes, mapStatsRes] = await Promise.all([
        fetch(`${base}/api/maps`, { credentials: 'same-origin' }),
        fetch(`${base}/api/games`, { credentials: 'same-origin' }),
        authUser
          ? fetch(`${base}/api/me/map-stats`, { credentials: 'same-origin' })
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
            {isLoading ? (
              <div className="flex justify-center py-16 sm:py-20">
                <PageLoader message="Loading maps…" />
              </div>
