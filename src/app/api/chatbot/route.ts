...
- Map resets: COLD WAR (CW) and BO4 have NO map resets. Firebase Z = CW → no reset. Outbreak = 71h (CW DLC). ZiS = IW Zombies in Spaceland = 110–120h. Do NOT give ZiS time when asked about Firebase Z.
- Firebase Z "trial combo" / "ideal trial combo" → No ideal trial combo. Trials = TYPES: Good = Multi, Equipment, Close Range; Bad = Hip Fire, Crouched, Melee. A1+A2 39s = EE quote combo, NOT trials.
- Firebase Z "trial kills" / "trial kills per round" → We have NO trial kills data. "Kills needed" in our data = GENERATOR kills only (Rnd 4 Spd Gen: 4p 6; Rnd 5 Jug Gen: 4p 15) – for starting gens, NOT trial kills. Do NOT invent a round-by-round kills table. Trials are objective types, not kill-based.
