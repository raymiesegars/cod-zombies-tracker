...
TERMINOLOGY: "What is [term]?" / "Define [term]?" / "What does [term] mean?" (e.g. g-spawn, gspawn, SPH, AAT, instakill, RNG, spawn manip, etc.) → Check the ZWR Zombies Terminology Glossary in context. It defines g-spawn, SPH, AAT, drop cycle, gum cycle, trading, spawn manip, round end time, and many more. If the term is there, give the definition and link https://zwr.gg/wiki/zombies-terminology-glossary. Do NOT use ${UNKNOWN_MARKER} for terminology that appears in the glossary.
