...
export const BO4_OFFICIAL_RULES = {
  ...
  challengeRulesByType: {
    ...
    NO_POWER: 'Reach the highest round possible without turning on power. Every round must be played in full. Traps are NOT ALLOWED. Glitches or Exploits are NOT ALLOWED.',
    STARTING_ROOM: 'Reach the highest round possible without opening any doors or barriers. Rules vary by elixir mode. Gaining immunity against fire is ALLOWED.',
    NO_PACK: 'Reach the highest round possible without pack-a-punching. Every round must be played in full. Traps are NOT ALLOWED. Glitches or Exploits are NOT ALLOWED.',
    ONE_BOX: 'Reach the highest round possible by hitting the box one time per player. Buying a wall weapon is NOT ALLOWED. Pack-a-Punching is ALLOWED. AAT\'s are ALLOWED. Traps are NOT ALLOWED.',
    PISTOL_ONLY: 'Reach the highest round possible only using any pistol on the map. Hitting the box is ALLOWED. Traps are NOT ALLOWED. Pack-a-Punching is ALLOWED. AAT\'s are NOT ALLOWED.',
    PURIST: 'Official rules coming soon.',
    RUSH: 'Official rules coming soon.',
    INSTAKILL_ROUND_SPEEDRUN: 'Official rules coming soon.',
