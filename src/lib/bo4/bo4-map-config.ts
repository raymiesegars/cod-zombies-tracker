...
export const BO4_MAP_CONFIG: Record<Bo4MapSlug, Bo4MapConfig> = {
  ix: {
    challengeTypes: ['HIGHEST_ROUND', 'NO_DOWNS', 'NO_PERKS', 'NO_POWER', 'STARTING_ROOM', 'RUSH', 'PURIST', 'ROUND_5_SPEEDRUN', 'ROUND_15_SPEEDRUN', 'ROUND_30_SPEEDRUN', 'ROUND_50_SPEEDRUN', 'ROUND_70_SPEEDRUN', 'ROUND_100_SPEEDRUN', 'ROUND_200_SPEEDRUN', 'EASTER_EGG_SPEEDRUN'],
  ...
  'blood-of-the-dead': {
    challengeTypes: ['HIGHEST_ROUND', 'NO_DOWNS', 'NO_PERKS', 'NO_POWER', 'STARTING_ROOM', 'RUSH', 'PURIST', 'ROUND_5_SPEEDRUN', 'ROUND_15_SPEEDRUN', 'ROUND_5_SPEEDRUN', 'ROUND_15_SPEEDRUN', 'ROUND_30_SPEEDRUN', 'ROUND_50_SPEEDRUN', 'ROUND_70_SPEEDRUN', 'ROUND_100_SPEEDRUN', 'ROUND_200_SPEEDRUN', 'INSTAKILL_ROUND_SPEEDRUN', 'EASTER_EGG_SPEEDRUN'],
