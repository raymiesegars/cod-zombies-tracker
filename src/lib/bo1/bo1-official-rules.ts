...
export const BO1_OFFICIAL_RULES = {
  generalRules: [
    {
      ...
      items: [
        ...
        { text: 'Configs that run all of the desired commands can be found here.', href: CONFIGS_URL },
        { text: 'The Competitive-T5 mod is ALLOWED, and can be found here.', href: COMPETITIVE_T5_URL },
        { text: 'Please refer to this document on how to play co-op within the community standards found here.', href: COOP_DOC_URL },
        { text: 'The following rules were finalized on May 3rd, 2025. Results can be viewed here.', href: RULES_RESULTS_URL },
      ],
    },
    {
      title: 'PC - Steam',
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Bypassing the 25 day Black Screen is ALLOWED, but must be done via the Config/Command/BIOS. You can find how to do those methods here.', href: BYPASS_25DAY_URL },
  ...
  challengeRules: [
    ...
    { name: 'No Pack-a-Punch', desc: 'Reach the highest round possible without pack-a-punching. Every round must be played in full. Traps are NOT ALLOWED. Glitches or Exploits are NOT ALLOWED. Multi-pov is required for co-op.' },
    { name: 'First Room', desc: 'Reach the highest round possible without opening any doors. Fixed backspeed is ALLOWED for SOLO ONLY on PC. Restricted Graphic Content is ALLOWED. Every round must be played in full. Glitches or Exploits are NOT ALLOWED.' },
    ...
    { name: 'Pistol Only', desc: 'Reach the highest round possible only using any pistol on the map. Hitting the box is ALLOWED. Picking up weapons other than Pistols is NOT ALLOWED. Using the Ray Gun is NOT ALLOWED. Traps are NOT ALLOWED. Pack-a-Punching is ALLOWED. Buying nades off the wall is NOT ALLOWED.' },
    { name: 'No Power', desc: 'Reach the highest round possible without turning on power. Every round must be played in full. Glitches or Exploits are NOT ALLOWED.' },
  ],
};
