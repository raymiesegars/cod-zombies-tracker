...
export const BO1_MAP_CONFIG: Record<Bo1MapSlug, Bo1ChallengeConfig> = {
  ...
  'bo1-nacht-der-untoten': {
    challengeTypes: ['HIGHEST_ROUND', 'STARTING_ROOM', 'ROUND_5_SPEEDRUN', 'ROUND_15_SPEEDRUN', 'ROUND_30_SPEEDRUN', 'ROUND_50_SPEEDRUN', 'ROUND_70_SPEEDRUN', 'ROUND_100_SPEEDRUN'],
