...
export const BOCW_MAP_CONFIG: Record<BocwMapSlug, BocwMapConfig> = {
  'die-maschine': {
    challengeTypes: ['HIGHEST_ROUND', 'NO_DOWNS', 'NO_PERKS', 'NO_POWER', 'STARTING_ROOM', 'PURIST', 'NO_ARMOR', 'ONE_BOX', 'PISTOL_ONLY', 'NO_PACK', 'ROUND_30_SPEEDRUN', 'ROUND_50_SPEEDRUN', 'ROUND_70_SPEEDRUN', 'ROUND_100_SPEEDRUN', 'ROUND_200_SPEEDRUN', 'ROUND_935_SPEEDRUN', 'EXFIL_SPEEDRUN', 'EXFIL_R21_SPEEDRUN', 'EASTER_EGG_SPEEDRUN'],
    highRoundWR: 935,
    noDownsWR: 935,
    puristWR: 358,
    firstRoomWR: 935,
  ...
  'firebase-z': {
    challengeTypes: ['HIGHEST_ROUND', 'NO_DOWNS', 'NO_PERKS', 'NO_POWER', 'STARTING_ROOM', 'PURIST', 'NO_ARMOR', 'ONE_BOX', 'PISTOL_ONLY', 'NO_PACK', 'ROUND_30_SPEEDRUN', 'ROUND_50_SPEEDRUN', 'ROUND_70_SPEEDRUN', 'ROUND_100_SPEEDRUN', 'ROUND_200_SPEEDRUN', 'ROUND_935_SPEEDRUN', 'EXFIL_SPEEDRUN', 'EXFIL_R21_SPEEDRUN', 'EASTER_EGG_SPEEDRUN', 'BUILD_EE_SPEEDRUN'],
    highRoundWR: 935,
    noDownsWR: 935,
    puristWR: 295,
    firstRoomWR: 476,
  ...
  outbreak: {
    challengeTypes: ['HIGHEST_ROUND', 'NO_DOWNS', 'NO_PERKS', 'NO_ARMOR', 'ROUND_10_SPEEDRUN', 'ROUND_20_SPEEDRUN', 'ROUND_30_SPEEDRUN', 'ROUND_50_SPEEDRUN', 'EASTER_EGG_SPEEDRUN'],
    highRoundWR: 2159,
    noDownsWR: 510,
