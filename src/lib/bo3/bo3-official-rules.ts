...
export const BO3_OFFICIAL_RULES = {
  ...
  challengeRules: [
    ...
    { name: 'First Room', desc: 'Reach the highest round possible without opening any doors. Rules vary by gums (No gums / Classic gums / Mega gums). Crawl Space is ALLOWED in co-op for sleeper purposes. Map-specific rules apply (see General Rules).' },
    { name: 'No Jug', desc: 'Reach the highest round possible without purchasing Juggernog.' },
    { name: 'No AATs', desc: 'Reach the highest round possible without using Alternate Ammo Types (AATs).' },
  ],
};
